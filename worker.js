/*
 * EazyFlare — CORS Proxy Worker
 * https://github.com/SchmitzWS/eazyflare
 *
...
async function handleRequest(request) {
  ...
  if (url.pathname === "/" || url.pathname === "") {
    ...
    return new Response(JSON.stringify({ success: true, message: "EazyFlare Proxy is running" }), { status: 200, headers: rh });
  }
